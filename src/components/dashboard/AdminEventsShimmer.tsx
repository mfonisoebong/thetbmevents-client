...
function ShimmerBlock({ className }: { className: string }) {
  return (
    <div
      className={cn(
        // Left-to-right shimmer with pseudo-element gradient
        'relative overflow-hidden rounded-xl bg-black/10 dark:bg-white/10',
        'before:absolute before:inset-0 before:-translate-x-full',
        'before:bg-gradient-to-r before:from-transparent before:via-white/35 before:to-transparent dark:before:via-white/20',
